...
int main(int argc,const char *argv[])
{
...

    {
        ...
        outputFile.Save("NegR2",pName+"_5N");
        outputFile.Save("Number",pName+"_5T");
        outputFile.Save("NegRatio",pName+"_6N");
        outputFile.Save("Number",pName+"_6T");
        outputFile.Save("intensity",pName+"_7N");
        outputFile.Save("Number",pName+"_7T");
        outputFile.Save("width",pName+"_8N");
        outputFile.Save("Number",pName+"_8T");
        outputFile.Save("center",pName+"_9N");
        outputFile.Save("Point2D",pName+"_9T");
        outputFile.Save("ptNumber",pName+"_10N");
        outputFile.Save("Number",pName+"_10T");
        outputFile.Save("centerSpot",pName+"_11N");
        outputFile.Save("Point2D",pName+"_11T");
        outputFile.Save("average",pName+"_12N");
        outputFile.Save("Number",pName+"_12T");
        outputFile.Save(12,pName+"_N");
