...
// Can put this into "MyGroup.cpp"

// #include "MyGroup.h" - If you do, uncomment this line
...
extern void Write(DTDataStorage &output,std::string name,const MyGroup &var)
{
...
extern void Read(DTDataStorage &input,std::string name,MyGroup &var)
{
    Read(input,name+"_process",var.process);
    Read(input,name+"_centers",var.centers);
}

extern void WriteOne(DTDataStorage &output,std::string name,const MyGroup &var)
{
...
DTTable StructureTable(const MyGroup &var)
{
    return DTTable();
}
