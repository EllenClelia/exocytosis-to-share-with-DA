...
int main(int argc,const char *argv[])
{
...

    {
        ...
        variableDataFile = DTDataFile("combined.dtbin",DTFile::ReadOnly);
        Read(variableDataFile,"combined",combined);
        start = inputDataFile.ReadNumber("start");
    }
    ...
    //DTTimer timer;
    //timer.Start();
    PeakGroup output = Computation(combined,start);
