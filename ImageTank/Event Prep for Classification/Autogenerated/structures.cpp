...
// Can put this into "PeakGroup.cpp"

// #include "PeakGroup.h" - If you do, uncomment this line
...
extern void Write(DTDataStorage &output,std::string name,const PeakGroup &var)
{
...
extern void Read(DTDataStorage &input,std::string name,PeakGroup &var)
{
...
extern void WriteOne(DTDataStorage &output,std::string name,const PeakGroup &var)
{
...
DTTable StructureTable(const PeakGroup &var)
{
    return DTTable();
}
